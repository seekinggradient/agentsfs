...
| --- | --- | --- | --- |
| H-01 | Hub file reader | A long bare URL widened a 390-pixel page to 533 pixels. The link extended to x=528, creating horizontal page scroll and making the article feel broken. | **Fixed here:** file-view Markdown links now wrap anywhere. |
