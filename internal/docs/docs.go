...
var commands = []Command{
	...
	{"Orient", "afs tasks [path] [--all|--ready|--band NAME] [--json]", "derived view of the backlog page: in-progress work, then ready work by band, then blocked/parked/done counts"},
