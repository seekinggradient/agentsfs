...
> 3. Start or resume an episode in the resolved journal’s active/ directory, then interview me briefly for domain context, not taxonomy: what is this memory for? Which people, organizations, projects, documents, systems, and decisions matter? What should a future session never have to ask me again?
...
> 6. Maintain the onboarding episode you started after orientation: checkpoint what you learned, seeded, and left open, with artifact links. Mark it complete when onboarding ends. Follow the journal INDEX.md for `afs journal` commands and expected hashes; do not wait until the end to create it.
