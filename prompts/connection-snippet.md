...
Reuse one journal entry for the entire conversation, across turns and compaction; create or update it only for learning, decisions, and context worth preserving; follow the journal INDEX.md for lifecycle and archival rules.
