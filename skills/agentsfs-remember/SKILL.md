...
- Own placement and structure. Do not ask the user where to put notes or how to structure the workspace; ask for missing domain context, then place, move, merge, or split files as needed. If the current structure is outgrown, improve it and explain what changed.
