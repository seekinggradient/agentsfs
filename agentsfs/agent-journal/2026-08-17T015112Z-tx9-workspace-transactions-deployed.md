...
- Production smoke checks returned 200 from `/healthz` and `/`, and the new transaction route returned the expected 401 without credentials. No authenticated write was attempted against a real knowledge base.
