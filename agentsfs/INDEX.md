...
The current human-facing product term is **workspace**; the hosted agent and compatibility surfaces retain older tool names where needed. The episodic-journal release is CLI v0.15.0 with contract 0.13.0; see [[2026-09-07T212300Z-ad2dd57acdb2e3fdbffecfb2-episode]] for its implementation and deployment record. The earlier terminology release remains recorded in [[agent-journal/2026-09-05T185002Z-wsp-workspace-terminology]].
