...
## Next
- [/] Contract: backlogs adopt `markdownto: backlog@0.1` — contract 0.11.1 shipped the SHOULD-adopt wording and task grammar on 2026-08-10; this live backlog is migrated, and the markdownto instance migration will complete with the projection rollout → [[contract-backlog-spec]] ^contract-backlog-spec
...
## Later
- [/] Build safe two-way sync for embedded Hub projections: recoverable host↔Hub base tracking, mapped three-way `afs hub pull`, exact snapshot-parent push, strict target identity, Hub-writer protocol gating, and migration of already-diverged projections → [[backlog/hub-projection-pull]] ^hub-projection-pull
