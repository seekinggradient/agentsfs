...
Root index for this knowledge base. Replace the `description:` above with a specific, one-line summary of what this instance is about and what lives in it — it is what `afs tree`, `afs status --json`, and the Hub show as this knowledge base's label. The contract itself lives in `AGENTS.md`; start there, then browse the top-level directories, each of which has its own `INDEX.md`.
